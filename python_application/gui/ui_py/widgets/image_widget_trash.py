...
################################################################################
## Form generated from reading UI file 'image_widget_trash.ui'
##
...
class Ui_image_widget_trash(object):
    def setupUi(self, image_widget_trash):
        if not image_widget_trash.objectName():
            image_widget_trash.setObjectName(u"image_widget_trash")
        image_widget_trash.resize(300, 200)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(image_widget_trash.sizePolicy().hasHeightForWidth())
        image_widget_trash.setSizePolicy(sizePolicy)
        image_widget_trash.setMinimumSize(QSize(300, 200))
        image_widget_trash.setMaximumSize(QSize(300, 200))
        image_widget_trash.setStyleSheet(u"QWidget#sub_widget {\n"
...
"}")
        ...
        self.sub_widget = QWidget(image_widget_trash)
        ...
        self.trash_btn = QPushButton(self.sub_widget)
        self.trash_btn.setObjectName(u"trash_btn")
        icon = QIcon()
        icon.addFile(u":/icons/assets/trash.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.trash_btn.setIcon(icon)
        self.trash_btn.setIconSize(QSize(30, 30))

        self.horizontalLayout.addWidget(self.trash_btn)
...
"")
        icon1 = QIcon()
        icon1.addFile(u":/icons/assets/magnify.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.magnify_btn.setIcon(icon1)
...
"")
        icon2 = QIcon()
        icon2.addFile(u":/icons/assets/heart.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.like_btn.setIcon(icon2)
...
"}")
        icon3 = QIcon()
        icon3.addFile(u":/icons/assets/heartred.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.liked_btn.setIcon(icon3)
        ...
        self.retranslateUi(image_widget_trash)

        QMetaObject.connectSlotsByName(image_widget_trash)
    # setupUi
    ...
    def retranslateUi(self, image_widget_trash):
        ...
        self.like_count.setText(QCoreApplication.translate("image_widget_trash", u"0", None))
    # retranslateUi
